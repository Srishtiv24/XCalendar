...
/*You need to know where the first piece goes (firstWeekday)
How many pieces to place (totalDays)
What to fill in before and after (prevMonthDays, lastWeekday)
And finally, you build the puzzle (html) and display it.
*/
